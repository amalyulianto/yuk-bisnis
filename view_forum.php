				...
				<div class="col-lg-12">
					...
					?>
						<div class="form-group comment">
							...
							<p class="mb-0">
								<large><b><?php echo $row['name'] ?></b></large> <span class="text-primary"><small class="mb-0"><i><?php echo $row['username'] ?></i></small></span>
							</p>
									...
									<div class="col-lg-8 offset-lg-2 replies">
										...
										?>
											<div class="form-group ty-compact-list">
												...
												<p class="mb-0">
													<large><b><?php echo $rep['name'] ?></b></large> <span class="text-primary"><small class="mb-0"><i><?php echo $rep['username'] ?></i></small></span>
												</p>
